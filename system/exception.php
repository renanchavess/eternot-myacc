...
function exception_handler($exception)
{
  ...
  $content = str_replace(
    ...
    [
      ...
      $backtrace_formatted,
      base64_decode(
        'UG93ZXJlZCBieSA8YSBocmVmPSJodHRwczovL2dpdGh1Yi5jb20vanByemltYmEvY3J5c3RhbHNlcnZlci1teWFjYyIgdGFyZ2V0PSJfYmxhbmsiPkNyeXN0YWwgU2VydmVyPC9hPiBhbmQgQ29udHJpYnV0b3JzLg=='
      ),
    ],
    $content
  );
